...
TARGET=resto
usage="## Post a resource to collection\n\n  Usage $0 -c <Collection name> -f <Resource description file> -u <username:password> [-x (do not use iTag if set) -s (use https if set)  -H server (default localhost) -p resto path (default resto)]\n"
