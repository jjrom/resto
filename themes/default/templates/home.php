...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $self->context->dictionary->language ?>">
    ...
    <body class="glass">
        ...
        <form id="resto-searchform-home" action="<?php echo $self->context->baseUrl . 'api/collections/search.html' ?>">
        <div class="row fullWidth" style="width:100%;text-align:center;">
            <div class="large-12 columns">
                <span class="resto-search"><input id="homesearch" class="darker" type="search" name="q" placeholder="<?php echo $self->context->dictionary->translate('_menu_search'); ?>" value="<?php echo isset($self->context->query['q']) ? $self->context->query['q'] : ''; ?>" style="font-size:1.5em;height:50px;width:500px;"></span>
            </div>
        </div>
        </form>
        ...
        $(document).ready(function() {
            ...
            $('#resto-searchform-home').submit(function(e) {
                e.preventDefault();
                R.showMask();
                this.submit();
            });
