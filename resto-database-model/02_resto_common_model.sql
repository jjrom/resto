...
CREATE TABLE IF NOT EXISTS __DATABASE_COMMON_SCHEMA__.user (
    ...
    settings            JSON DEFAULT '{"createdCatalogIsPublic":true,"createdCollectionIsPublic":true,"createdItemIsPublic":true,"notifyOnAddFeature":true,"notifyOnNewFollower":true,"notifyOnLikeFeature":true,"notifyOnAddComment":true,"showBio":false,"showIdentity":false,"showTopics":false,"showEmail":false,"profileNeedReview":true}'
