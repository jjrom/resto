 ...
 *   - add option to not check expiration date
 */
class JWT
{
     ...
     */
    public static function decode($jwt, $key, array $allowed_algs, $checkExpiration = true)
    {
        ...
        // Check if this token has expired unless checkExpiration is false
        if ($checkExpiration) {
