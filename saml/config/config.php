...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => ((getenv('PUBLIC_ENDPOINT') != '') ? getenv('PUBLIC_ENDPOINT') . '/simplesaml/' : 'simplesaml/'),
     ...
     */
    'technicalcontact_name' => ((getenv('SAML_TECHNICAL_CONTACT_NAME') != '') ? getenv('SAML_TECHNICAL_CONTACT_NAME') : 'admin'),
    'technicalcontact_email' => ((getenv('SAML_TECHNICAL_CONTACT_EMAIL') != '') ? getenv('SAML_TECHNICAL_CONTACT_EMAIL') : 'admin@example.org'),
     ...
     */
    'timezone' =>  ( (getenv('TIMEZONE') != '') ? getenv('TIMEZONE') : 'Europe/Paris' ),
     ...
     */
    'secretsalt' =>  ( (getenv('SAML_SECRET_SALT') != '') ? getenv('SAML_SECRET_SALT') : 'supersecretsalt' ),
     ...
     */
    'auth.adminpassword' =>  ( (getenv('SAML_ADMIN_PASSWORD') != '') ? getenv('SAML_ADMIN_PASSWORD') : 'admin' ),
     ...
     */
    'session.cookie.secure' => (strtolower(getenv('SAML_SECURE_COOKIE')) === 'true') ? true : false,
