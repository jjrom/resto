...
--
-- licenses table describe all resto licenses
--
CREATE TABLE IF NOT EXISTS resto.license (

    -- License unique identifier
    licenseid                       TEXT PRIMARY KEY,

    -- Comma separated list of isoa2 list of allowed user countries
    grantedcountries                TEXT,

    -- Comma separated list of isoa2 list of allowed users organization countries 
    grantedorganizationcountries    TEXT,

    -- Comma separated list of flags allowed
    grantedflags                    TEXT, 

    -- Enumeration : 'public', 'private'
    viewservice                     TEXT DEFAULT 'public',

    -- Enumeration : 'never', 'once', 'always'
    hastobesigned                   TEXT NOT NULL,

    -- Maximum of signatures allowed if hastobesigned = 'always' (-1 means unlimited) 
    signaturequota                  INTEGER DEFAULT -1,

    -- JSON object with one entry per language
...
--
CREATE TABLE IF NOT EXISTS resto.signature (

    -- Reference to resto.user.id
    userid              BIGINT NOT NULL,

    -- Reference to resto.license.id
    licenseid           TEXT NOT NULL,

    -- Sign timestamp
    signed              TIMESTAMP NOT NULL,

    -- Number of time the user sign the license
    counter             INTEGER
